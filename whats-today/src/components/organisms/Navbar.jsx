export default function Navbar() {
    return (
        <div className="flex flex-col md:mb-8 md:flex-row w-full md:py-4 md:px-6 bg-white sticky top-0 z-10">
            ...
            <div className="hidden md:flex flex-row gap-4 pl-16">
                <div className="flex justify-center items-end cursor-pointer gap-14">
                    <span className={`font-semibold text-orange-400 text-3xl pb-2 relative inline-block group mb-4 cursor-pointer`}>
                        Home
