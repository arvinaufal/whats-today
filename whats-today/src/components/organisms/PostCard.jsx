...
export default function PostCard({ post }) {
    return (
        <div className="flex flex-col w-full border-b border-slate-400 md:border-none md:w-1/2 px-6 py-4 bg-white md:rounded-3xl shadow-xl hover:shadow-2xl cursor-default">
